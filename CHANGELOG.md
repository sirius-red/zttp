...
- Hardened secure server protocol negotiation so invalid bytes and unsupported
  ALPN selections fail explicitly instead of silently falling back to an
  unrelated protocol path.
